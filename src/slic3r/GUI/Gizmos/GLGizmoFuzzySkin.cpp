...
void GLGizmoFuzzySkin::on_render_input_window(float x, float y, float bottom_limit)
{
    ...
    for (int i = 0; i < tool_ids.size(); i++) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Button       , is_active ? ImVec4(187.f / 255.f, 216.f / 255.f, 0.f, .25f) : ImVec4(0,0,0,0));         // ORCA
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, is_active ? ImVec4(187.f / 255.f, 216.f / 255.f, 0.f, .25f) : ImVec4(.6f,.6f,.6f,.2f)); // ORCA
        ImGui::PushStyleColor(ImGuiCol_ButtonActive , is_active ? ImVec4(187.f / 255.f, 216.f / 255.f, 0.f, .30f) : ImVec4(0,0,0,0));         // ORCA
