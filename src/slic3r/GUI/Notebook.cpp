...
void ButtonsListCtrl::SetSelection(int sel)
{
    ...
    wxColour selected_btn_bg("#BBD800");    // Mosso Verde Lime selection accent
    ...
    StateColor bg_color = StateColor(
        std::pair{wxColour(187, 216, 0), (int) StateColor::Hovered},
        std::pair{wxColour(187, 216, 0), (int) StateColor::Normal});
    m_pageButtons[m_selection]->SetBackgroundColor(bg_color);
