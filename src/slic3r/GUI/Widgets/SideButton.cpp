    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(166, 192, 0), StateColor::Pressed);
    border_color.append(wxColour(166, 192, 0), StateColor::Hovered);
    border_color.append(0xBBD800, StateColor::Normal);
    ...
    background_color.append(wxColour(166, 192, 0), StateColor::Pressed);
    background_color.append(wxColour(166, 192, 0), StateColor::Hovered);
    background_color.append(0xBBD800, StateColor::Normal);
