    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0xA6C000, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0xBBD800, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#BBD800", "#BBD800"};
wxString btn_confirm[10]  = {"#DFDFDF", "#BBD800", "#A6C000", "#BBD800", "#BBD800", "#6B6A6A", "#262E30", "#262E30", "#BBD800", "#BBD800"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#BBD800", "#BBD800"};
