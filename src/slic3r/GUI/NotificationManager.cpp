	...
	, m_notification_start  (GLCanvas3D::timestamp_now())
{
    ...
    m_NormalColor = ImVec4(187.f / 255.f, 216.f / 255.f, 0.f, 1.f);

	m_CurrentColor = m_NormalColor;   //Default

	m_WindowBkgColor = ImVec4(1, 1, 1, 1);
    m_TextColor      = ImVec4(.2f, .2f, .2f, 1.0f);
    m_HyperTextColor = ImVec4(187.f / 255.f, 216.f / 255.f, 0.f, 1.f);
}
...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = ImVec4(187.f / 255.f, 216.f / 255.f, 0.f, 1.f); // Mosso Verde Lime #BBD800
	m_HyperTextColorHover = ImVec4(166.f / 255.f, 192.f / 255.f, 0.f, 1.f); // Mosso Verde Lime hover #A6C000
