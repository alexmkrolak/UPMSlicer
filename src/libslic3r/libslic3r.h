...
#define SLIC3R_APP_FULL_NAME "Mosso Slicer"
#define GCODEVIEWER_APP_NAME "Mosso Slicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "MossoSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("Mosso Slicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
